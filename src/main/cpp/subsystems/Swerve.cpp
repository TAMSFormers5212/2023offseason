...
using namespace units;
  ...
  void Swerve::Periodic(){
    ...
    frc::SmartDashboard::PutNumber("tl apos", m_modules[0].getAbsolutePosition()*360);
    frc::SmartDashboard::PutNumber("tr apos", m_modules[1].getAbsolutePosition()*360);
    frc::SmartDashboard::PutNumber("bl apos", m_modules[2].getAbsolutePosition()*360);
    frc::SmartDashboard::PutNumber("br apos", m_modules[3].getAbsolutePosition()*360);
